...
void contractor_ibex_fwdbwd::prune(box & b, SMTConfig & config, vector<box> &) {
...
void contractor_ibex_newton::prune(box & b, SMTConfig & config, vector<box> &) {
...
void contractor_ibex_hc4::prune(box & b, SMTConfig & config, vector<box> &) {
...
void contractor_ibex_polytope::prune(box & b, SMTConfig & config, vector<box> &) {
