...
public:
    ...
    void prune(box & b, SMTConfig & config, std::vector<box> & bin);
    void prune_naive(box & b, SMTConfig & config, std::vector<box> & bin);
    std::ostream & display(std::ostream & out) const;
};
...
public:
    ...
    void prune(box &, SMTConfig &, std::vector<box> &) {
...
public:
    ...
    void prune(box & b, SMTConfig &, std::vector<box> &) {
        b.set_empty();
    }
    std::ostream & display(std::ostream & out) const {
...
private:
    ...
    void naive_fixpoint_alg(box & b, SMTConfig & config, std::vector<box> & bin);
    // Worklist fixedpoint algorithm
    void worklist_fixpoint_alg(box & b, SMTConfig & config, std::vector<box> & bin);
